...
/**
 * Classe ZPentomino
 * Cette classe permet de définir la piece Z
 * @since extension pentominos
 */
public class ZPentomino extends Pentomino {

    /**
     * Constructeur de la classe ZPentomino
     * @param coordonnees Coordonnees de la piece
     * @param couleur Couleur de la piece
     */
    public ZPentomino(Coordonnees coordonnees, Couleur couleur){
