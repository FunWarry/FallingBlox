...
/**
 * Classe VPentomino
 * Cette classe permet de définir la piece V
 * @since extension pentominos
 */
public class VPentomino extends Pentomino {

    /**
     * Constructeur de la classe VPentomino
    ...
    protected void setElements(Coordonnees coordonnees, Couleur couleur) {
        ...
        super.getElements()[1].setCoordonnees(new Coordonnees(coordonnees.getAbscisse(), coordonnees.getOrdonnee()-2));
