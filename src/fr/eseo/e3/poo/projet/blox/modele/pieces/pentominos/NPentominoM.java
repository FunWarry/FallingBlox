...
/**
 * Classe NPentominoM
 * Cette classe permet de définir la piece N en Miroir
 * @since extension pentominos
 */
public class NPentominoM extends Pentomino {

    /**
     * Constructeur de la classe NPentomino
     * @param coordonnees Coordonnees de la piece
     * @param couleur Couleur de la piece
     */
    public NPentominoM(Coordonnees coordonnees, Couleur couleur){
