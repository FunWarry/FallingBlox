...
public class TPentomino extends Pentomino {
    ...
    protected void setElements(Coordonnees coordonnees, Couleur couleur) {
        ...
        super.getElements()[2].setCoordonnees(new Coordonnees(coordonnees.getAbscisse(), coordonnees.getOrdonnee()-1));
        super.getElements()[3].setCoordonnees(new Coordonnees(coordonnees.getAbscisse()+1, coordonnees.getOrdonnee()-1));
