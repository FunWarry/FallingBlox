...
/**
 * Classe ZPentominoM
 * Cette classe permet de définir la piece Z miroir
 * @since extension pentominos
 */
public class ZPentominoM extends Pentomino {

    /**
     * Constructeur de la classe ZPentominoM
     * @param coordonnees Coordonnees de la piece
     * @param couleur Couleur de la piece
     */
    public ZPentominoM(Coordonnees coordonnees, Couleur couleur){
    ...
    protected void setElements(Coordonnees coordonnees, Couleur couleur) {
        ...
        super.getElements()[2].setCoordonnees(new Coordonnees(coordonnees.getAbscisse()-1, coordonnees.getOrdonnee()-1));
