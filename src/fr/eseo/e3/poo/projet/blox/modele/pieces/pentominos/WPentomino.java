...
/**
 * Classe WPentomino
 * Cette classe permet de définir la piece W
 * @since extension pentominos
 */
public class WPentomino extends Pentomino {

    /**
     * Constructeur de la classe WPentomino
     * @param coordonnees Coordonnees de la piece
     * @param couleur Couleur de la piece
     */
    public WPentomino(Coordonnees coordonnees, Couleur couleur){
